...
tests = do
  ...
  return $ testGroup "OPMLTestCases"
    [ testProperty "Error: xmlOPML0"    $ prop_getOPML xml0 True 0
    , testProperty "NoError: xmlOPML1"  $ prop_getOPML xml1 False 2 "My Title 1"
    , testProperty "NoError: xmlOPML2"  $ prop_getOPML xml2 False 4 "My Title 2"
    ]
